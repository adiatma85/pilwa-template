...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.paslon.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.paslons.update", [$paslon->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.paslon.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $paslon->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visi') ? 'is-invalid' : '' }}" type="text" name="visi" id="visi" value="{{ old('visi', $paslon->visi) }}">
                @if($errors->has('visi'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('misi') ? 'is-invalid' : '' }}" name="misi" id="misi">{!! old('misi', $paslon->misi) !!}</textarea>
                @if($errors->has('misi'))
